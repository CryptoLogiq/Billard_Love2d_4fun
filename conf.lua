function love.conf(t)
    ...
    t.window.title = "8 Pool 2024 : CryptoLogiq"         -- Titre de la fenêtre (string)
    t.window.icon = nil                 -- Chemin du fichier vers une image à utiliser comme icône de la fenêtre (string)
    t.window.width = 1920                -- Largeur de la fenêtre (number)
    t.window.height = 1000               -- Hauteur de la fenêtre (number)
